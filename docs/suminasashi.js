...
function findWasmBinary() {
    return locateFile("suminasashi.wasm")
}
...
var findCanvasEventTarget = target => {
    target = maybeCStringToJsString(target);
    return GL.offscreenCanvases[target.slice(1)] || target == "canvas" && Object.keys(GL.offscreenCanvases)[0] || document.querySelector(target)
};
...
var _display, _takeScreenshot, _clearCanvas, _main, _malloc, _free, __emscripten_stack_restore, __emscripten_stack_alloc, _emscripten_stack_get_current;

function assignWasmExports(wasmExports) {
    Module["_display"] = _display = wasmExports["mg"];
    Module["_takeScreenshot"] = _takeScreenshot = wasmExports["ng"];
    Module["_clearCanvas"] = _clearCanvas = wasmExports["og"];
    Module["_main"] = _main = wasmExports["qg"];
    _malloc = wasmExports["rg"];
    _free = wasmExports["sg"];
    __emscripten_stack_restore = wasmExports["tg"];
    __emscripten_stack_alloc = wasmExports["ug"];
    _emscripten_stack_get_current = wasmExports["vg"]
}
var wasmImports = {
    xa: GetWindowInnerHeight,
    ya: GetWindowInnerWidth,
    m: ___assert_fail,
    K: ___cxa_throw,
    ...
    Qf: _emscripten_glBindFramebuffer,
    Pf: _emscripten_glBindRenderbuffer,
    ub: _emscripten_glBindSampler,
    Of: _emscripten_glBindTexture,
    mb: _emscripten_glBindTransformFeedback,
    wc: _emscripten_glBindVertexArray,
    ag: _emscripten_glBindVertexArrayOES,
    Nf: _emscripten_glBlendColor,
    Mf: _emscripten_glBlendEquation,
    Lf: _emscripten_glBlendEquationSeparate,
    Kf: _emscripten_glBlendFunc,
    Jf: _emscripten_glBlendFuncSeparate,
    ...
    Df: _emscripten_glClearColor,
    Cf: _emscripten_glClearDepthf,
    Bf: _emscripten_glClearStencil,
    Db: _emscripten_glClientWaitSync,
    bd: _emscripten_glClipControlEXT,
    Af: _emscripten_glColorMask,
    zf: _emscripten_glCompileShader,
    yf: _emscripten_glCompressedTexImage2D,
    Rc: _emscripten_glCompressedTexImage3D,
    xf: _emscripten_glCompressedTexSubImage2D,
    Pc: _emscripten_glCompressedTexSubImage3D,
    Pb: _emscripten_glCopyBufferSubData,
    wf: _emscripten_glCopyTexImage2D,
    vf: _emscripten_glCopyTexSubImage2D,
    Sc: _emscripten_glCopyTexSubImage3D,
    ...
    Ib: _emscripten_glDrawArraysInstanced,
    Xf: _emscripten_glDrawArraysInstancedANGLE,
    Xa: _emscripten_glDrawArraysInstancedARB,
    ...
    Yf: _emscripten_glDrawBuffersWEBGL,
    cf: _emscripten_glDrawElements,
    Hb: _emscripten_glDrawElementsInstanced,
    Wf: _emscripten_glDrawElementsInstancedANGLE,
    Va: _emscripten_glDrawElementsInstancedARB,
    Wa: _emscripten_glDrawElementsInstancedEXT,
    Yc: _emscripten_glDrawElementsInstancedNV,
    Vc: _emscripten_glDrawRangeElements,
    bf: _emscripten_glEnable,
    af: _emscripten_glEnableVertexAttribArray,
    Kc: _emscripten_glEndQuery,
    hg: _emscripten_glEndQueryEXT,
    pc: _emscripten_glEndTransformFeedback,
    Gb: _emscripten_glFenceSync,
    ...
    Fb: _emscripten_glIsSync,
    ge: _emscripten_glIsTexture,
    jb: _emscripten_glIsTransformFeedback,
    sc: _emscripten_glIsVertexArray,
    Zf: _emscripten_glIsVertexArrayOES,
    fe: _emscripten_glLineWidth,
    ee: _emscripten_glLinkProgram,
    ib: _emscripten_glPauseTransformFeedback,
    de: _emscripten_glPixelStorei,
    ad: _emscripten_glPolygonModeWEBGL,
    ce: _emscripten_glPolygonOffset,
    cd: _emscripten_glPolygonOffsetClampEXT,
    fb: _emscripten_glProgramBinary,
    eb: _emscripten_glProgramParameteri,
    gg: _emscripten_glQueryCounterEXT,
    ...
    hb: _emscripten_glResumeTransformFeedback,
    _d: _emscripten_glSampleCoverage,
    rb: _emscripten_glSamplerParameterf,
    qb: _emscripten_glSamplerParameterfv,
    ...
    Vd: _emscripten_glStencilFuncSeparate,
    Ud: _emscripten_glStencilMask,
    Td: _emscripten_glStencilMaskSeparate,
    Sd: _emscripten_glStencilOp,
    Rd: _emscripten_glStencilOpSeparate,
    Qd: _emscripten_glTexImage2D,
    Uc: _emscripten_glTexImage3D,
    ...
    Tc: _emscripten_glTexSubImage3D,
    ...
    zd: _emscripten_glUniform3i,
    yd: _emscripten_glUniform3iv,
    ...
    Jb: _emscripten_glUniformBlockBinding,
    ...
    Vf: _emscripten_glVertexAttribDivisorANGLE,
    ...
    ed: _emscripten_glVertexAttribPointer,
    dd: _emscripten_glViewport,
    Cb: _emscripten_glWaitSync,
    ...
    za: _emscripten_set_window_title,
    Ja: _environ_get,
